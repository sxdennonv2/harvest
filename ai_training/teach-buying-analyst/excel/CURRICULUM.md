...
- [0001 — Relative & absolute references](lessons/relative-and-absolute-references.html)
- [0002 — Tables: the modern foundation](lessons/tables-the-modern-foundation.html)
- [0003 — Sort & Filter: order and isolate](lessons/sort-and-filter.html)
- [0004 — Data validation: controlled dropdowns](lessons/data-validation-dropdowns.html)
- [0005 — Text formulas: clean & combine](lessons/text-formulas-clean-and-combine.html)
- [0006 — Get & Transform (Power Query)](lessons/get-and-transform-power-query.html)
...
|---|---|---|---|---|
| **Source & prepare** | ✅ [0001 References](lessons/relative-and-absolute-references.html); ✅ [0002 Tables](lessons/tables-the-modern-foundation.html); ✅ [0003 Sort & Filter](lessons/sort-and-filter.html); ✅ [0004 Data validation](lessons/data-validation-dropdowns.html); ✅ [0005 Text formulas](lessons/text-formulas-clean-and-combine.html); ✅ [0006 Get & Transform](lessons/get-and-transform-power-query.html); Get & Transform basics | Ask it to write/explain a formula or SQL snippet | "Clean and shape this pasted extract" | Build a clean, shaped workbook from a raw file |
| **Summarise & analyse** | ✅ [0007 Logical & IFERROR](lessons/logical-functions-and-iferror.html); ✅ [0008 Aggregation & precision](lessons/aggregation-and-precision.html); ✅ [0009 SUMIFS](lessons/sumifs-totals-by-criteria.html); ✅ [0010 XLOOKUP](lessons/xlookup-pull-matching-details.html); ✅ [0011 Date & time](lessons/date-and-time-functions.html); ✅ [0012 PivotTables](lessons/pivottables-summarise-in-seconds.html); ↳ ✅ [0012.1 Slicers](lessons/add-sliders-to-pivottables.html); ✅ [0013 Dynamic arrays](lessons/dynamic-arrays-filter-sort-unique.html) | Interpret a pivot; sanity-check a calculation | "Summarise the trends in this range" | Build a workbook that summarises the data end-to-end |
