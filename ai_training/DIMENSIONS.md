...
|---|---|---|---|
| `application` | swappable tree root | Excel ✅ · Outlook · PowerPoint · Word | frame (one course.json each) |
| `theme` | swappable tree, nested in application | Excel: Source & prepare · Summarise & analyse · Report & visualise · Communicate & present · Automate the repetitive (all ✅) | frame — elicited per app: *"what are the fundamental pillars of functionality within {app}?"* |
| `lesson` | tree leaf, nested in theme (+ subcards; `builds_on` DAG edges) | Excel: 19 ✅ | frame |
